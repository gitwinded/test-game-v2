...
local quadInfo = {
	...
	,
	down = {
		{'down',	16,	32,	-1,	-1,	1,	1	}, -- facing forward
		{'down1',	32,	32,	-1,	-1,	1,	1	}, -- walking forward step 1
		{'down',	16,	32,	-1,	-1,	1,	1	}, -- facing forward
		{'down2',	0,	32,	-1,	-1,	1,	1	}} -- walking forward step 2
	,
	up = {
		{'up',		16,	16,	-1,	-1,	1,	1	}, -- facing backward
		{'up1',		0,	16,	-1,	-1,	1,	1	}, -- walking backward step 1
		{'up',		16,	16,	-1,	-1,	1,	1	}, -- facing backward
		{'up2',		32,	16,	-1,	-1,	1,	1	}} -- walking backward step 2
	,
	status = {
	...
	Character:create(16, 16, imgPath, quadInfo)
